...
require "functions.php";
  ...
  if(isset($_POST["tambah"])){
    ...
    if (addDataAdmin($_POST, $_FILES) > 0) {
        echo "
            <script>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="dataAdmin.php">Data Admin</a></li>
                            ...
                            <div class="card card-primary">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="passwordConfirm" class="form-control"
                                                id="passwordConfirm" placeholder="KONFIRMASI PASSSWORD" required>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="dataAdmin.php" type="submit" class="btn btn-warning">Kembali</a>
                                    </div>
                                </form>
