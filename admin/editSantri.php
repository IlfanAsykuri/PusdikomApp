...
if(isset($_GET["niup"])){
  ...
  $allDataKamar = loadData("SELECT * FROM tb_kamar");
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card card-primary">
                                ...
                                <form action="" method="POST">
                                    <div class="card-body">
                                        <input type="hidden" name="niupHidden" value="<?= $loadDataByNIUP["niup"] ?>"
                                            class="form-control" id="niup" placeholder="NIUP">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" value="<?= $loadDataByNIUP["nama"] ?>" class="
                                                form-control" id="nama" placeholder="NAMA" require>
                                        </div>
                                        <div class="form-group">
                                            <label for="jenisKelamin">Jenis Kelamin</label>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="jenisKelamin"
                                                    id="laki-laki" value="laki-laki" <?= $checkedLk ?>>
                                                <label class="form-check-label" for="laki-laki">Laki-laki</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="jenisKelamin"
                                                    id="perempuan" value="perempuan" <?= $checkedPR ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="devisi">
                                                ...
                                                <?php
                                                $selectedDevisi = "";
                                                if($loadDataByNIUP["kode_devisi"] == $devisi["kode_devisi"]){
                                                  $selectedDevisi = "selected";
                                                }
                                              ?>
                                                <option value="<?= $devisi["kode_devisi"] ?> <?= $selectedDevisi ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="kamar">
                                                ...
                                                <?php
                                                  $selectedKamar = "";
                                                  if($loadDataByNIUP["kode_kamar"] == $kamar["kode_kamar"]){
                                                    $selectedKamar = "selected";
                                                  }
                                                  ?>
                                                <option value="<?= $kamar["kode_kamar"] ?>" <?= $selectedKamar ?>>
                                                    <?= $kamar["kode_kamar"] . " - " . $kamar["kamar"] ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
