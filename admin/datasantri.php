                        ...
                        <section class="col-lg-12 connectedSortable">
                            <div class="card">
                                <div class="card-header">
                                    <a href="tambahdatasantri.php" class="btn btn-sm btn-primary"><i
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-hover text-nowrap text-center">
                                        ...
                                        <tbody>
                                            <?php $i = 1; ?>
                                            <?php foreach($allDataSantri as $santri) : ?>
                                            <tr>
                                                <td><?= $i; ?></td>
                                                <td><?= $santri["niup"]; ?></td>
                                                <td><?= $santri["nama"]; ?></td>
                                                ...
                                                <td>
                                                    <a href="detailSantri.php?niup=<?= $santri["niup"] ?>"
                                                        class="btn btn-sm btn-info"><i
                                                            class="fa-solid fa-circle-info"></i></a>
                                                    <a href="editSantri.php?niup=<?= $santri["niup"] ?>"
                                                        class="btn btn-sm btn-success"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    <a href="hapusSantri.php?niup=<?= $santri["niup"] ?>"
