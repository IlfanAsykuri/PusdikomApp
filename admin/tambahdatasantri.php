                                ...
                                <form action="" method="POST">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="niup" class="form-control" id="niup"
                                                placeholder="NIUP" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="merklaptop" class="form-control" id="merklaptop"
                                                placeholder="MERK LAPTOP" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="tipelaptop">TIPE LAPTOP</label>
                                            <input type="text" name="tipelaptop" class="form-control" id="tipelaptop"
                                                placeholder="TIPE LAPTOP" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="macaddress">MAC ADDRESS LAPTOP</label>
                                            <input type="text" name="macaddress" class="form-control" id="macaddress"
                                                placeholder="MAC ADDRESS LAPTOP" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="nolemari">NO LEMARI</label>
                                            <input type="text" name="nolemari" class="form-control" id="nolemari"
                                                placeholder="NO LEMARI" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Devisi</label>
                                            <select class="form-control" name="devisi">
                                                ...
                                                <option
                                                    value="<?= $devisi["kode_devisi"] . " - " . $devisi["devisi"]?>">
                                                    <?= $devisi["kode_devisi"] . " - " . $devisi["devisi"]?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="kamar">
                                                ...
                                                <option value="<?= $kamar["kode_kamar"] . " - " . $kamar["kamar"]?>">
                                                    <?= $kamar["kode_kamar"] . " - " . $kamar["kamar"] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
